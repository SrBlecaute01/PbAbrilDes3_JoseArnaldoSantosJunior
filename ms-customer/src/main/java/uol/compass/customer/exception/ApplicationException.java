package uol.compass.customer.exception;
...
@Schema(name = "Application exception.", description = "The exception schema.")
public class ApplicationException {
    ...
    @Schema(description = "The path of the exception.", example = "/v1/customers")
    private final String path;

    @Schema(description = "The errors of the exception.", example = "{\"cpf\":\"cpf must be informed\"}")
